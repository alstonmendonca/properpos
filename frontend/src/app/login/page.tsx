...
import { Eye, EyeOff, Zap, Loader2, ArrowRight, BarChart3, Package, CreditCard } from 'lucide-react';
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="mt-4 text-gray-400 text-base leading-relaxed max-w-md">
                Join thousands of businesses using ProperPOS to manage sales, track inventory, and grow revenue.
              </p>
            </div>

            <div className="space-y-4">
              {[
                { icon: CreditCard, text: 'Fast, reliable checkout experience' },
                { icon: Package, text: 'Real-time inventory tracking' },
                { icon: BarChart3, text: 'Powerful business analytics' },
              ].map(({ icon: Icon, text }) => (
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-5">
            <p className="text-sm text-gray-300 leading-relaxed">
              "ProperPOS has completely transformed how we manage our three locations. The real-time analytics alone have helped us increase revenue by 30%."
            </p>
            <div className="mt-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-gray-500">Owner, Urban Brew Cafe</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <Button
              ...
              onClick={() => setFormError('Google sign-in is not yet configured. Please use email and password.')}
            >
            ...
            <Button
              ...
              type="button"
              className="cursor-pointer"
              onClick={() => setFormError('Apple sign-in is not yet configured. Please use email and password.')}
            >
          ...
          <p className="mt-8 text-center text-sm text-muted-foreground">
            ...
            <Link href="/register" className="font-medium text-primary hover:text-primary/80 transition-colors cursor-pointer">
              Sign up for free
            </Link>
          </p>
        </div>
